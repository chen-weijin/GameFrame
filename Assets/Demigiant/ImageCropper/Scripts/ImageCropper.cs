...
public class ImageCropper : MonoBehaviour
{
	...
	public static GameObject ImageCropperObj;
	...
	public static ImageCropper Instance
	{
		get
		{
			if (m_instance == null)
			{
				if (ImageCropperObj!=null)
				{
					var obj = ImageCropperObj;
					m_instance= Instantiate(obj).GetComponent<ImageCropper>();
				}
				else
				{
					return null;
				...
				//Todo
				// var obj = SystemResManager.Instance.Load("Assets/AppAssets/Hall/ResAB/UI/PersonalInfo/ImageCropper.prefab") as GameObject;
				// m_instance= Instantiate(obj).GetComponent<ImageCropper>();
			}
